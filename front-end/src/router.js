...
import LocalizacaoCadastro from './pages/LocalizacaoCadastro.vue'
...
const routes = [
  ...
  { path: '/emprestimos', component: EmprestimoLista },
  { path: '/emprestimos/novo', component: EmprestimoCadastro },

  { path: '/bibliotecarios', component: BibliotecarioLista },
  { path: '/bibliotecarios/novo', component: BibliotecarioCadastro },

  { path: '/bibliotecas', component: BibliotecaLista },
  { path: '/bibliotecas/novo', component: BibliotecaCadastro },
   ...
   { path: '/localizacoes', component: LocalizacaoLista },
   { path: '/localizacoes/novo', component: LocalizacaoCadastro },
]
